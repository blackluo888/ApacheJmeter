...
public class HTTPHC4Impl extends HTTPHCAbstractImpl {
    ...
    protected HTTPSampleResult sample(URL url, String method,
        ...
        try {
            ...
            for(int i =0;i<headers.length;i++){
            	if("Authorization".equals(headers[i].getName())){
            		httpRequest = HTTPOAuth.httpRequest(oAuthMap, paramMap, httpRequest);
            	}
            }
    ...
    public Map<String,String> setOAuth(org.apache.jmeter.protocol.http.control.Header header){
    	if("Authorization".equals(header.getName())){
    		String headerValue = header.getValue();
    		String[] heads = headerValue.split(";");
    		for(String head:heads){
    			String[] headKey =head.split("=");
    			oAuthMap.put(headKey[0], headKey[1]);
    		}
    	}
    	return oAuthMap;
    ...
    protected String sendPostData(HttpPost post)  throws IOException {
        ...
        if(getUseMultipartForPost()) {
            ...
            for (JMeterProperty jMeterProperty : getArguments()) {
                ...
                getParam(arg.getName(), arg.getValue());
...
//            post.setHeader(HEADER_CONTENT_TYPE, multiPartContentType);
    ...
    private Map<String,Object> getParam(String key,String value){
    	if(key != null){
